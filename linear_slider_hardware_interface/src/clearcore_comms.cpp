...
bool ClearCoreComms::begin(const std::string& remote_ip, int remote_port_arg, int local_port_arg) {
    remote_port = remote_port_arg;
    ...
    client_addr.sin_addr.s_addr = inet_addr(remote_ip.c_str());
